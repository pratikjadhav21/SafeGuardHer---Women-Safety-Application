...
public class ServiceMine extends Service {
    ...
    public void onCreate() {
        ...
        ShakeDetector.create(this, () -> {
            ...
            if(!ENUM.equalsIgnoreCase("NONE")){
                ...
                Media.playAudio(this, R.raw.siren);
                // play it from your preferred activity. and you can change raw file to your path also its depends upon your requirement.
            }
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
            ...
            if (intent.getAction().equalsIgnoreCase("Stop")) {
                ...
                Intent notificationIntent = new Intent(this, Interface.class);
